// @ts-nocheck
import { addLeadingSlash, CONTEXT_ACTIONS, Current, document, env, eventCenter, getPageById, initStyleSheetConfig, removePageById, requestAnimationFrame, setPageById, window } from '../../../runtime'
import { EMPTY_OBJ, hooks, isUndefined } from '../../../shared'
...
import type { TaroElement, TFunc } from '../../../runtime'
